    ...
    <div className="container mt-5">
      <div className="row align-items-center">
        ...
        <div className="col-md-6" style={{ marginTop: "-320px"}}>
          <h1 className="text-dark fw-bold mb-3" class="font-serif " style={{fontSize:"30px", textDecoration:"underline"}}>STUDY TUNE</h1>
          <p className="text-secondary" style={{fontSize:"20px"}} class="font-sans">
